...
$KOTOSHI="2021";
define("HOME" , "www.sctennisclub.org/membership/json");
define("JSON19" , "www.sctennisclub.org/membership/json19");
define("JSON20" , "www.sctennisclub.org/membership/json20");
define("JSON21" , "www.sctennisclub.org/membership/json21");


//$DIR = "http://localhost/sctc/membership";       
$DIR = "membership";
if( OnLocalHost() ) $DIR = "sc/membership";       

$DIR = "http://www.sctennisclub.org/membership";       
...
//   echo "<a style=text-decoration:none href=/$DIR/members/jsonp>$KYONEN</a>&nbsp";
//   echo "<a style=text-decoration:none href=/$DIR/members/json>$KOTOSHI</a>&nbsp";

//    echo "<a style=text-decoration:none href=$DIR/member_json.php?year=2019>$KYONEN</a>&nbsp";
//    echo "<a style=text-decoration:none href=$DIR/member_json.php>$KOTOSHI</a>&nbsp";


    echo "<a style=text-decoration:none href=$DIR/members/2019>$OTOTOSHI</a>&nbsp";
    echo "<a style=text-decoration:none href=$DIR/members/2020>$KYONEN</a>&nbsp";
    echo "<a style=text-decoration:none href=$DIR/members/2021>$KOTOSHI</a>&nbsp";
...
// JSON way
// RewriteRule ^json$ json.php  [NC,QSA,L]
// membership/json
// membership/jsonp

// 2019: JSONP 2020:JSON 2021:JSON1

   $URL = JSON21;
   if ($YEAR == $KOTOSHI-1) $URL = JSON20;
   if ($YEAR == $KOTOSHI-2) $URL = JSON19;
