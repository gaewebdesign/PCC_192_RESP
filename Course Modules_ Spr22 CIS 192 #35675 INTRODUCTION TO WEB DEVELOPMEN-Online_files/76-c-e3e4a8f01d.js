...
return a()?{isCyoeAble:e&&o,isTrigger:e&&o&&i(e),isReleased:d(e),releasedLabel:u(e)}:{}}}},G4i8:function(e,o,c){var t={"./__tests__/lti.resourceImported.test.js":["LFe7",4175],"./__tests__/lti.screenReaderAlert.test.js":["0Guc",4176],"./__tests__/lti.showAlert.test.js":["+y7l",4177],"./__tests__/requestFullWindowLaunch.test.js":["o6ta",4178],"./lti.enableScrollEvents.js":["HVU3",4239],"./lti.fetchWindowSize.js":["OANa",4240],"./lti.frameResize.js":["bSyB",4167],"./lti.removeUnloadMessage.js":["tjuu",4179],"./lti.resourceImported.js":["FC2N",4241],"./lti.screenReaderAlert.js":["YYEg",4242],"./lti.scrollToTop.js":["W/R1",4243],"./lti.setUnloadMessage.js":["6fDN",4180],"./lti.showAlert.js":["onLg",4244],"./lti.showModuleNavigation.js":["NSTA",4245],"./org.imsglobal.lti.capabilities.js":["zPPZ",4246],"./requestFullWindowLaunch.js":["8IHO",4247],"./toggleCourseNavigationMenu.js":["ECMy",3664,4248]}
...
return c===a.points.key?_.t("%{score} pts",{score:_.n(e,{precision:2,strip_insignificant_zeros:true})}):c===a.letter_grade.key||c===a.gpa_scale.key?e:_.n(e,{precision:2,percentage:true,strip_insignificant_zeros:true})}
...
const m=(e,o)=>{if("string"===typeof e&&o.grading_type!==a.letter_grade.key&&o.grading_type!==a.gpa_scale.key){const c=s["a"].parse(e.replace(/%$/,""))
...
c.d(o,"l",(function(){return _}))
c.d(o,"i",(function(){return s}))
...
c.d(o,"c",(function(){return k}))
var t=c("fhP7")
const l="error"
const r="unsupported_subject"
const n="wrong_origin"
const a="bad_request"
const _=({targetWindow:e,origin:o,subject:c,message_id:t})=>{const _=(l={})=>{const r={subject:c+".response"}
t&&(r.message_id=t)
e?e.postMessage({...r,...l},o):console.error("Error sending response postMessage: target window does not exist")}
const s=()=>{_({})}
const i=(e,o)=>{const c={code:e}
o&&(c.message=o)
_({error:c})}
const d=e=>{i(l,e)}
const u=e=>{i(a,e)}
const p=()=>{i(n)}
const k=()=>{i(r)}
return{sendResponse:_,sendSuccess:s,sendError:i,sendGenericError:d,sendBadRequestError:u,sendWrongOriginError:p,sendUnsupportedSubjectError:k}}
var s=_
const i={}
const d=["lti.enableScrollEvents","lti.fetchWindowSize","lti.frameResize","lti.removeUnloadMessage","lti.resourceImported","lti.screenReaderAlert","lti.scrollToTop","lti.setUnloadMessage","lti.showAlert","lti.showModuleNavigation","org.imsglobal.lti.capabilities","requestFullWindowLaunch","toggleCourseNavigationMenu"]
const u=["A2ExternalContentReady","LtiDeepLinkingResponse",t["i"],t["b"],t["j"]]
async function p(e,o=false){if(e.data.source&&e.data.source.includes("react-devtools"))return false
let t
try{t="string"===typeof e.data?JSON.parse(e.data):e.data}catch(e){return false}const l=t.subject||t.messageType
const r=s({targetWindow:e.source,origin:e.origin,subject:l,message_id:t.message_id})
if(u.includes(l))return false
if(!d.includes(l)){o&&r.sendUnsupportedSubjectError()
return false}if(!o&&l.includes("org.imsglobal.lti"))return false
try{const n=await c("G4i8")(`./${l}.js`)
const a=n.default({message:t,event:e,responseMessages:r})
!a&&o&&r.sendSuccess()
return true}catch(e){console.error(`Error loading or executing message handler for "${l}": ${e}`)
o&&r.sendGenericError(e.message)
return false}}function k(){var e,o
const c=null===(e=ENV)||void 0===e||null===(o=e.FEATURES)||void 0===o?void 0:o.lti_platform_storage
window.addEventListener("message",e=>{""!==e.data&&p(e,c)})}}}])

//# sourceMappingURL=76-c-e3e4a8f01d.js.map