...
var s=t("EyBU")
t("dhbk")
var l=function(e,a){return function(){return e.apply(a,arguments)}},c=function(e,a){for(var t in a)d.call(a,t)&&(e[t]=a[t])
function n(){this.constructor=e}n.prototype=a.prototype
e.prototype=new n
e.__super__=a.prototype
return e},d={}.hasOwnProperty,u=[].slice
...
a.prototype.save=function(e,t){var n,o,_,r,l,c
null==e&&(e={})
null==t&&(t={})
...
Object(s["uploadFile"])(this.preflightUrl,c,o).then(l)["catch"](r)
return n}
a.prototype.isFile=true
a.prototype.toJSON=function(){var e
if(!this.get("file"))return a.__super__.toJSON.apply(this,arguments)
return _.a.pick.apply(_.a,[this.attributes,"file"].concat(u.call(_.a.keys(null!=(e=this.uploadParams)?e:{}))))}
...
return i.post(e,a).catch(c).then(e=>v(e.data,t,{ajaxLib:i,onProgress:_}))}function v(e,a,t={}){const i=t.ajaxLib||n["a"]
const _=t.ajaxLibOptions||{}
...
const{upload_url:r,progress:s}=e
if(!r)return Object(l["a"])(s,{ajaxLib:i}).catch(u)
let{file_param:c,upload_params:p,success_url:v}=e
c=c||"file"
p=p||{}
v=v||p.success_url
const h=!!v
const f=new FormData
Object.entries(p).forEach(([e,a])=>f.append(e,a))
a&&f.append(c,a,t.filename)
const m=i.post(r,f,{responseType:h?"document":"json",onUploadProgress:t.onProgress,withCredentials:!h,..._})
return m.catch(d).then(e=>{if(s)return Object(l["a"])(s,{ajaxLib:i}).catch(u)
let a,n={}
if(v){const{Bucket:t,Key:i,ETag:o}=e.data
a=v
n={bucket:t,key:i,etag:o}}else if(201===e.status&&!t.ignoreResult){a=e.data.location
n={}}if(a){t.includeAvatar&&(n.include="avatar")
n=o.a.stringify(n)
n&&(a=-1!==a.indexOf("?")?`${a}&${n}`:`${a}?${n}`)
return i.get(a).then(({data:e})=>e).catch(u)}return e.data})}function h(e,a,t){const n=`/api/v1/courses/${a}/assignments/${t}/submissions/self/comments/files`
const i=e.map(e=>{const a={name:e.name,content_type:e.type}
return p(n,a,e)})
return Promise.all(i)}function f(e,a){const t=e.map(e=>e.url?p(a,{url:e.url,name:e.title,content_type:e.mediaType,submit_assignment:false}):p(a,{name:e.name,content_type:e.type},e))
...
const{url:_,workflow_state:r,results:s,message:l}=e
if("queued"===r||"running"===r){let{interval:e}=a
e||(e=1e3)
e<100&&(e=100)
return i(e).then(()=>t.get(_)).then(e=>{const t=e.data
return o(t,a)})}return"completed"===r?Promise.resolve(s):Promise.reject(l)}}}])

//# sourceMappingURL=56-c-97a9a68936.js.map