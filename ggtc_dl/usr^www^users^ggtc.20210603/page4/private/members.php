...
<script src="private/jquery.tablesort.js"></script>
...
//    alert(msg)
   ...
   // from private/jquery.tablesort.js
   $('table').tablesort();
...
//                      msg = "Invalid username and password prviate/checkUser.php )".getcwd()."<br>";
                        msg = "Invalid username and password  <p>";

                        $("#message").html(msg);

//                        loc  = window.location.pathname + "<br><p>";
//                        $("#message").html(loc);
...
function get( ){
      ...
      $r = rand(0,21);  // random between 0,21
...
$photo = get(); 
echo( "<p><img src='private/images/$photo'  width='600' >)");
