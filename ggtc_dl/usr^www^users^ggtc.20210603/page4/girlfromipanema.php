...
<table align="center" class="sortabler" width="50%">
...
//      echo( strpos( $SERVER, "gate" ) );
      ...
      $url = "www.sfmongoldata.appspot.com";
      $url = "http://www.sctennisclub.org/accept";
      $Y = 2019;  // default year
...
/*
      $url = "www.sfmongoldata.appspot.com/redirect";
      $url = "http://www.sctennisclub.org/accept/current";
      $url = "http://www.sctennisclub.org/accept/previous";
*/

// ********************************************************************
//    override if localhost
//    $url = "www.ggtcmongoldata.appspot.com/short";
//    override if localhost
...
function Ukraine()
{
      ...
      $subject = "GGTC/SCTC Visitor Statistics: ".$city."  ".$region." ".$country;
      $message = $subject." <br>";
