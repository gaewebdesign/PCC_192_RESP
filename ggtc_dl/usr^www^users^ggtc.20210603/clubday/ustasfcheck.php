...
// Create GAE Data
             GAEData( $fname, $lname ,$gender, $rating, $city);
// Create GAE Data
...
function GAEData( $fname, $lname ,$gender, $rating, $city)
{
...
//   $t =  date_usec( $t  );
   ...
   $txt = $space."g = Member(key=ndb.Key(Member,$KEY))";
          
   fwrite( $FILEHANDLE, $txt."\r\n");

   $txt = $space."g.year=2018";
   fwrite( $FILEHANDLE, $txt."\r\n");
